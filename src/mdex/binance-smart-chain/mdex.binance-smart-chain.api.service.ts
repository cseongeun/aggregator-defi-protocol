...
@Injectable()
export class MdexBinanceSmartChainApiService extends MdexBinanceSmartChainBase {
  /***************************
   *  FOR ADDRESS
   ***************************/
  ...
  private _formatFarmResult(farInfoZip: any) {
    const output = [];

    farInfoZip.forEach(([farm, infoResult]) => {
